...
// Array with SVGs, links, and text
const contactItems = [
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    href: "https://nxtninja.hashnode.dev/",
    text: "Read my articles on Hashnode",
  },
  {
    icon: (
      <svg
    ...
    href: "https://www.linkedin.com/in/priyangsubanik/",
...
const Contact = () => {
  ...
  return (
    <section
      ...
      ref={contactRef}
    >
      <div className="grid grid-cols-1 md:grid-cols-5 gap-10 p-5 w-full">
        <motion.div
          className="col-span-5 md:col-span-3 flex flex-col gap-8"
        ...
        >
          <div className="space-y-2">
            ...
            <p className="max-w-lg">
              Contact me for your next amazing project. Let's get on a call and
              see what we can do! Looking forward to hearing from you.
            </p>
          </div>
        ...
        {/* Contact form */}
        <motion.div
          className="col-span-5 md:col-span-2 flex flex-col gap-2 w-full"
          initial={{ opacity: 0, x: 50 }}
          animate={isInView ? { opacity: 1, x: 0 } : {}}
        ...
        >
          <form>
            <div className="w-full space-y-3">
              ...
              <Input label="Enter email" className="w-full" />
              <Textarea label="Enter message" className="w-full" minRows={5} />
              <Button
                fullWidth
                size="lg"
                className="bg-foreground-900 text-white"
              >
                Send
              </Button>
            </div>
